...
exports.rule = entities.Issue.onChange({
  ...
  action: function (ctx) {
    const issuesMap = [
      ...
      {'com.intellij.diagnostic.PluginException: Cannot load class com.perl5.lang.pod.idea.editor.PodSpellCheckingStrategy': 'CAMELCADE-24430'},
      {'com.intellij.diagnostic.PluginException: Cannot load class com.perl5.lang.perl.idea.editor.PerlSpellCheckingStrategy': 'CAMELCADE-24430'},
    ...
    for (const [pattern, targetIssueId] of Object.entries(issuesMap)) {
