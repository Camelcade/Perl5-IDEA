...
public abstract class PerlParserLikeTest extends PerlParserTestBase {
  @Override
  ...
  @Test
  public void testAnnotationDoubleVar() { doTest(false); }
  ...
  @Test
  public void testAnnotatedScalars() { doTest(); }

  @Test
  public void testAnnotatedArrays() { doTest(); }

  @Test
  public void testAnnotatedHashes() { doTest(); }
