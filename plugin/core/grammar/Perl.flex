...
%xstate STRING_Q, STRING_QQ, STRING_QQ_METAQUOTED, STRING_QX, STRING_QX_METAQUOTED, STRING_LIST
...
<STRING_QQ_METAQUOTED> "\\E"     {yybegin(STRING_QQ);return STRING_SPECIAL_MODIFIER_END;}
<STRING_QX_METAQUOTED> "\\E"     {yybegin(STRING_QX);return STRING_SPECIAL_MODIFIER_END;}
<STRING_QQ> "\\Q"                {yybegin(STRING_QQ_METAQUOTED);return STRING_SPECIAL_QUOTE_START;}
