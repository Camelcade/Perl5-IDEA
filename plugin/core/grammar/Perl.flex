...
%state UNICODE_SUBSTITUTION, UNICODE_SUBSTITUTION_IN_BRACE, UNICODE_SUBSTITUTION_CODE, UNICODE_SUBSTITUTION_CLOSE_BRACE
...
<UNICODE_SUBSTITUTION_IN_BRACE>{
  "U+"                {yybegin(UNICODE_SUBSTITUTION_CODE);return STRING_SPECIAL_UNICODE_CODE_PREFIX;}
  {UNICODE_CHAR_NAME} {yybegin(UNICODE_SUBSTITUTION_CLOSE_BRACE);return STRING_CHAR_NAME;}
  [^]                 {yypushback(1);yybegin(UNICODE_SUBSTITUTION_CLOSE_BRACE);}
}

<UNICODE_SUBSTITUTION_CODE>{
  {SIMPLE_HEX_NUMBER} {yybegin(UNICODE_SUBSTITUTION_CLOSE_BRACE);return NUMBER_HEX;}
  [^]                 {yypushback(1);yybegin(UNICODE_SUBSTITUTION_CLOSE_BRACE);}
}

<UNICODE_SUBSTITUTION_CLOSE_BRACE>{
