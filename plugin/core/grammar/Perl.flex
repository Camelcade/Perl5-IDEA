...
%xstate STRING_QQ, STRING_QQ_CHAR, STRING_QQ_METAQUOTED_CHAR, STRING_QQ_METAQUOTED,
%xstate STRING_QX, STRING_QX_CHAR, STRING_QX_METAQUOTED_CHAR, STRING_QX_METAQUOTED
...
<STRING_QQ,STRING_QQ_METAQUOTED,STRING_QX,STRING_QX_METAQUOTED,MATCH_REGEX,MATCH_REGEX_X,MATCH_REGEX_XX,REGEX_QUOTED_X,REGEX_CHARCLASS_X,REGEX_CHARCLASS_XX,REPLACEMENT_REGEX>
{
...
<STRING_QQ_METAQUOTED_CHAR> [^]  {yybegin(STRING_QQ_METAQUOTED);return STRING_CONTENT_QQ;}
<STRING_QX_METAQUOTED_CHAR> [^]  {yybegin(STRING_QX_METAQUOTED);return STRING_CONTENT_XQ;}
<STRING_QQ>{
    "\\Q"             {yybegin(STRING_QQ_METAQUOTED);return STRING_SPECIAL_QUOTE_START;}
    "\\"              {yybegin(STRING_QQ_CHAR);return STRING_SPECIAL_ESCAPE_CHAR;}
}
<STRING_QX>{
    "\\Q"             {yybegin(STRING_QX_METAQUOTED);return STRING_SPECIAL_QUOTE_START;}
    "\\"              {yybegin(STRING_QX_CHAR);return STRING_SPECIAL_ESCAPE_CHAR;}
}
<STRING_QQ_METAQUOTED>{
    "\\E"             {yybegin(STRING_QQ);return STRING_SPECIAL_MODIFIER_END;}
    "\\"              {yybegin(STRING_QQ_METAQUOTED_CHAR);return STRING_SPECIAL_ESCAPE_CHAR;}
}
<STRING_QX_METAQUOTED>{
    "\\E"             {yybegin(STRING_QX);return STRING_SPECIAL_MODIFIER_END;}
    "\\"              {yybegin(STRING_QX_METAQUOTED_CHAR);return STRING_SPECIAL_ESCAPE_CHAR;}
}
