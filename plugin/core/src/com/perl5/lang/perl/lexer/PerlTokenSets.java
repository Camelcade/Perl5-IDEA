...
public interface PerlTokenSets extends PerlElementTypes, MooseElementTypes {
  ...
  TokenSet SPECIAL_STRING_TOKENS = TokenSet.create(
    ...
    STRING_SPECIAL_CONTROL,
    STRING_SPECIAL_CONTROL_OTHER,

    STRING_SPECIAL_HEX,
    STRING_SPECIAL_HEX_RESTRICTED,
    STRING_SPECIAL_UNICODE_NAME,
    STRING_SPECIAL_UNICODE_CODE,
    STRING_SPECIAL_OCTAL,
    STRING_SPECIAL_OCTAL_RESTRICTED,
