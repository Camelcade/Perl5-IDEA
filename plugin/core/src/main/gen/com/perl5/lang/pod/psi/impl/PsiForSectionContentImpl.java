...
public class PsiForSectionContentImpl extends PodCompositeElementMixin implements PsiForSectionContent {

  public PsiForSectionContentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitForSectionContent(this);
  }
