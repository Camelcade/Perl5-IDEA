...
public class PsiPerlArrayUnshiftExprImpl extends PsiPerlExprImpl implements PsiPerlArrayUnshiftExpr {

  public PsiPerlArrayUnshiftExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitArrayUnshiftExpr(this);
  }
