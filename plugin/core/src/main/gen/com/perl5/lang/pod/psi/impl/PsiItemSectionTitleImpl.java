...
import com.perl5.lang.pod.parser.psi.mixin.PodSectionItemTitleMixin;
import com.perl5.lang.pod.psi.*;

public class PsiItemSectionTitleImpl extends PodSectionItemTitleMixin implements PsiItemSectionTitle {

  public PsiItemSectionTitleImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitItemSectionTitle(this);
  }
