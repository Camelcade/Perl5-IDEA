...
public class PsiPerlDefaultCompoundImpl extends PerlCompositeElementImpl implements PsiPerlDefaultCompound {

  public PsiPerlDefaultCompoundImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitDefaultCompound(this);
  }
