...
public class PsiPerlCodeVariableImpl extends PerlVariableMixin implements PsiPerlCodeVariable {
  ...
  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitCodeVariable(this);
  }
  ...
  public PsiPerlMethod getMethod() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, PsiPerlMethod.class));
  }
