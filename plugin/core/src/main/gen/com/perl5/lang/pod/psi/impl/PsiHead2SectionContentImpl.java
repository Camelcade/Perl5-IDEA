...
public class PsiHead2SectionContentImpl extends PodCompositeElementMixin implements PsiHead2SectionContent {

  public PsiHead2SectionContentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitHead2SectionContent(this);
  }
