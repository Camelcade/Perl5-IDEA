...
public class PsiPerlBlessExprImpl extends PsiPerlExprImpl implements PsiPerlBlessExpr {

  public PsiPerlBlessExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitBlessExpr(this);
  }
