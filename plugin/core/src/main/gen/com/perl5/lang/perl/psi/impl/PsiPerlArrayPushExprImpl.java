...
public class PsiPerlArrayPushExprImpl extends PsiPerlExprImpl implements PsiPerlArrayPushExpr {

  public PsiPerlArrayPushExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitArrayPushExpr(this);
  }
