...
public class PsiPerlFileGlobExprImpl extends PsiPerlExprImpl implements PsiPerlFileGlobExpr {

  public PsiPerlFileGlobExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitFileGlobExpr(this);
  }
