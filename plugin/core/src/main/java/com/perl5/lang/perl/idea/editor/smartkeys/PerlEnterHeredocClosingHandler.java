...
public class PerlEnterHeredocClosingHandler extends PerlEnterHandler {
  ...
  private static class HeredocCollector extends PerlPsiUtil.HeredocProcessor {
    ...
    public boolean process(PsiElement element) {
      ...
      if (element instanceof PerlHeredocOpener perlHeredocOpener) {
        //SmartPointerManager#createSmartPsiElementPointer
        myResult.add(SmartPointerManager.getInstance(element.getProject()).createSmartPsiElementPointer(perlHeredocOpener));
      }
      return true;
    }
