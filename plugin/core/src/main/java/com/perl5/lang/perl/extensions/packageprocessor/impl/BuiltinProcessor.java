...
public class BuiltinProcessor extends PerlPragmaProcessorBase {
  @Override
  public void addExports(@NotNull PerlUseStatementElement useStatement, @NotNull Set<String> export, @NotNull Set<String> exportOk) {
    PerlImplicitDeclarationsService.getInstance(useStatement.getProject())
      .processSubsInPackage("builtin", it -> exportOk.add(it.getSubName()));
  }
}
