...
internal class PerlStartMarker(delegate: PsiBuilder.Marker, perlDebugBuilder: PerlDebugBuilder) :
  PsiBuilderImpl.StartMarker((delegate as ProductionMarker).markerId, perlDebugBuilder), PsiBuilder.Marker {

  private val myDelegate: PsiBuilderImpl.StartMarker = delegate as PsiBuilderImpl.StartMarker
  private val myStartTokenIndex: Int = (delegate as ProductionMarker).startIndex
  ...
  override fun addChild(node: ProductionMarker) {
  ...
  private fun rawTokenIndex() = ((myDelegate as ProductionMarker).myBuilder as PsiBuilderImpl).rawTokenIndex()
