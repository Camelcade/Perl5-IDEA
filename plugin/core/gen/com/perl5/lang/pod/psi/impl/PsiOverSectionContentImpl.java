...
public class PsiOverSectionContentImpl extends PodOverSectionContent implements PsiOverSectionContent {

  public PsiOverSectionContentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitOverSectionContent(this);
  }
  ...
  @Override
  @NotNull
  public List<PsiItemSection> getItemSectionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PsiItemSection.class);
  }
