...
import com.perl5.lang.pod.parser.psi.mixin.PodFormatterC;
import com.perl5.lang.pod.psi.*;

public class PsiPodFormatCodeImpl extends PodFormatterC implements PsiPodFormatCode {

  public PsiPodFormatCodeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitPodFormatCode(this);
  }
