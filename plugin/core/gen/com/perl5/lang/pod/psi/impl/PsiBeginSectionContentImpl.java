...
public class PsiBeginSectionContentImpl extends PodCompositeElementMixin implements PsiBeginSectionContent {

  public PsiBeginSectionContentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitBeginSectionContent(this);
  }
