...
public class PsiItemSectionContentImpl extends PodCompositeElementMixin implements PsiItemSectionContent {

  public PsiItemSectionContentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitItemSectionContent(this);
  }
