...
public class PsiFormattingSectionContentImpl extends PodCompositeElementMixin implements PsiFormattingSectionContent {

  public PsiFormattingSectionContentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitFormattingSectionContent(this);
  }
