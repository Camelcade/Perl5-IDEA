...
public class PodParser implements PsiParser, LightPsiParser {
  ...
  public static boolean begin_section_content(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, true, false, recover_begin_section_parser_);
    return true;
  }
  ...
  public static boolean over_section_content(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, true, false, recover_over_section_parser_);
    return true;
  }
  ...
  static boolean parse_default_section_content(PsiBuilder builder_, int level_) {
    return parse_section_content(builder_, level_ + 1, default_formatting_section_item_parser_);
  }
  ...
  static boolean parse_quoted_section(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, POD_QUOTE_DOUBLE);
    result_ = result_ && link_section(builder_, level_ + 1, quoted_section_negation_parser_);
  ...
  static boolean parse_unquoted_section(PsiBuilder builder_, int level_) {
    return link_section(builder_, level_ + 1, section_negation_parser_);
  }
  ...
  public static boolean pod_format_link(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && parse_section_content(builder_, level_ + 1, link_formatting_section_parser_);
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  static final Parser default_formatting_section_item_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return default_formatting_section_item(builder_, level_ + 1);
    }
  };
  static final Parser link_formatting_section_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return link_formatting_section(builder_, level_ + 1);
    }
  };
  static final Parser quoted_section_negation_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return quoted_section_negation(builder_, level_ + 1);
    }
  };
  static final Parser recover_begin_section_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return recover_begin_section(builder_, level_ + 1);
    }
  };
  static final Parser recover_over_section_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return recover_over_section(builder_, level_ + 1);
    }
  };
  static final Parser section_negation_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return section_negation(builder_, level_ + 1);
    }
  };
}
