...
public class PsiPerlArrayShiftExprImpl extends PsiPerlExprImpl implements PsiPerlArrayShiftExpr {

  public PsiPerlArrayShiftExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitArrayShiftExpr(this);
  }
