...
public class PsiPerlHashrefTypeImpl extends PerlCompositeElementImpl implements PsiPerlHashrefType {

  public PsiPerlHashrefTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitHashrefType(this);
  }
