...
public class PsiPerlTrycatchCompoundImpl extends PerlCompositeElementImpl implements PsiPerlTrycatchCompound {

  public PsiPerlTrycatchCompoundImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitTrycatchCompound(this);
  }
