...
public class PsiPerlLpRegexXImpl extends PerlCompositeElementImpl implements PsiPerlLpRegexX {

  public PsiPerlLpRegexXImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitLpRegexX(this);
  }
