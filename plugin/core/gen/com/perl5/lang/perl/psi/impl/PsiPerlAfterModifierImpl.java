...
public class PsiPerlAfterModifierImpl extends PerlMethodModifierMixin implements PsiPerlAfterModifier {

  public PsiPerlAfterModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitAfterModifier(this);
  }
