...
public class PsiPerlFileReadExprImpl extends PsiPerlExprImpl implements PsiPerlFileReadExpr {
  ...
  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitFileReadExpr(this);
  }
  ...
  @Override
  @NotNull
  public PsiPerlPerlHandleExpr getPerlHandleExpr() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, PsiPerlPerlHandleExpr.class));
  }
