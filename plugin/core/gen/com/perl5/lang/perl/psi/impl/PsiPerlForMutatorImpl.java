...
public class PsiPerlForMutatorImpl extends PerlCompositeElementImpl implements PsiPerlForMutator {

  public PsiPerlForMutatorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitForMutator(this);
  }
