...
public class PsiPerlHeredocQxImpl extends PerlCompositeElementImpl implements PsiPerlHeredocQx {

  public PsiPerlHeredocQxImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitHeredocQx(this);
  }
