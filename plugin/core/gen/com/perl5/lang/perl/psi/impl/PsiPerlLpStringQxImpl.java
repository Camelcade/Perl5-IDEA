...
public class PsiPerlLpStringQxImpl extends PerlCompositeElementImpl implements PsiPerlLpStringQx {

  public PsiPerlLpStringQxImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitLpStringQx(this);
  }
