...
public class PsiPerlCaseDefaultImpl extends PerlCompositeElementImpl implements PsiPerlCaseDefault {

  public PsiPerlCaseDefaultImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitCaseDefault(this);
  }
