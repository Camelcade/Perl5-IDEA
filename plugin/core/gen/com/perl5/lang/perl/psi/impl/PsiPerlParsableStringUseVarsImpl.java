...
public class PsiPerlParsableStringUseVarsImpl extends PerlCompositeElementImpl implements PsiPerlParsableStringUseVars {

  public PsiPerlParsableStringUseVarsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitParsableStringUseVars(this);
  }
