...
public class PsiPerlLpRegexImpl extends PerlCompositeElementImpl implements PsiPerlLpRegex {

  public PsiPerlLpRegexImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitLpRegex(this);
  }
