...
public class PsiPerlDoBlockExprImpl extends PsiPerlExprImpl implements PsiPerlDoBlockExpr {

  public PsiPerlDoBlockExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitDoBlockExpr(this);
  }
