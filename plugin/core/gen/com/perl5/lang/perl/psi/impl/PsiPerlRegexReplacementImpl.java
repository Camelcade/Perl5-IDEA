...
public class PsiPerlRegexReplacementImpl extends PerlCompositeElementImpl implements PsiPerlRegexReplacement {

  public PsiPerlRegexReplacementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitRegexReplacement(this);
  }
