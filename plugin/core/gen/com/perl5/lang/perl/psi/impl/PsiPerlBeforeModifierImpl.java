...
public class PsiPerlBeforeModifierImpl extends PerlMethodModifierMixin implements PsiPerlBeforeModifier {

  public PsiPerlBeforeModifierImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitBeforeModifier(this);
  }
