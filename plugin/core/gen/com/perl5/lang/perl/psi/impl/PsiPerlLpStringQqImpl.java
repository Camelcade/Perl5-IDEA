...
public class PsiPerlLpStringQqImpl extends PerlCompositeElementImpl implements PsiPerlLpStringQq {

  public PsiPerlLpStringQqImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitLpStringQq(this);
  }
