...
public class PsiPerlLpCodeBlockImpl extends PerlCompositeElementImpl implements PsiPerlLpCodeBlock {

  public PsiPerlLpCodeBlockImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitLpCodeBlock(this);
  }
