...
public class PsiPerlAnnotationReturnsImpl extends PerlCompositeElementImpl implements PsiPerlAnnotationReturns {

  public PsiPerlAnnotationReturnsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitAnnotationReturns(this);
  }
