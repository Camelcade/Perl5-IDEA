...
public interface PerlElementTypesGenerated {
  ...
  IElementType LP_CODE_BLOCK = PerlElementTypeFactory.getElementType("LP_CODE_BLOCK");
  IElementType LP_CODE_BLOCK_WITH_TRYCATCH = PerlElementTypeFactory.getElementType("LP_CODE_BLOCK_WITH_TRYCATCH");
  ...
  IElementType LP_REGEX = PerlElementTypeFactory.getElementType("LP_REGEX");
  IElementType LP_REGEX_REPLACEMENT = PerlElementTypeFactory.getElementType("LP_REGEX_REPLACEMENT");
  IElementType LP_REGEX_X = PerlElementTypeFactory.getElementType("LP_REGEX_X");
  IElementType LP_REGEX_XX = PerlElementTypeFactory.getElementType("LP_REGEX_XX");
  IElementType LP_STRING_Q = PerlElementTypeFactory.getElementType("LP_STRING_Q");
  IElementType LP_STRING_QQ = PerlElementTypeFactory.getElementType("LP_STRING_QQ");
  IElementType LP_STRING_QW = PerlElementTypeFactory.getElementType("LP_STRING_QW");
  IElementType LP_STRING_QX = PerlElementTypeFactory.getElementType("LP_STRING_QX");
  ...
  IElementType LEFT_BRACE_CODE_START = PerlElementTypeFactory.getTokenType("code{");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ADD_EXPR) {
      ...
      else if (type == AFTER_MODIFIER) {
        return new PsiPerlAfterModifierImpl(node);
      }
      ...
      else if (type == ANNOTATION_RETURNS) {
      ...
      else if (type == AROUND_MODIFIER) {
        return new PsiPerlAroundModifierImpl(node);
      }
      else if (type == AROUND_SIGNATURE_INVOCANTS) {
        return new PsiPerlAroundSignatureInvocantsImpl(node);
      }
      else if (type == ARRAYREF_TYPE) {
      ...
      else if (type == ARRAY_POP_EXPR) {
        return new PsiPerlArrayPopExprImpl(node);
      }
      else if (type == ARRAY_PUSH_EXPR) {
        return new PsiPerlArrayPushExprImpl(node);
      }
      else if (type == ARRAY_SHIFT_EXPR) {
        return new PsiPerlArrayShiftExprImpl(node);
      }
      else if (type == ARRAY_SLICE) {
        return new PsiPerlArraySliceImpl(node);
      }
      else if (type == ARRAY_UNSHIFT_EXPR) {
        return new PsiPerlArrayUnshiftExprImpl(node);
      }
        ...
        return new PsiPerlAttributesImpl(node);
      }
      else if (type == AUGMENT_MODIFIER) {
        return new PsiPerlAugmentModifierImpl(node);
      }
      else if (type == BEFORE_MODIFIER) {
        return new PsiPerlBeforeModifierImpl(node);
      }
      ...
      else if (type == BLESS_EXPR) {
        return new PsiPerlBlessExprImpl(node);
      }
      else if (type == BLOCK) {
        return new PsiPerlBlockImpl(node);
      }
      else if (type == BLOCK_COMPOUND) {
        return new PsiPerlBlockCompoundImpl(node);
      }
      else if (type == CALL_ARGUMENTS) {
        return new PsiPerlCallArgumentsImpl(node);
      }
      else if (type == CASE_COMPOUND) {
        return new PsiPerlCaseCompoundImpl(node);
      }
      else if (type == CASE_CONDITION) {
        return new PsiPerlCaseConditionImpl(node);
      }
      else if (type == CASE_DEFAULT) {
        return new PsiPerlCaseDefaultImpl(node);
      }
      ...
      else if (type == COMMENT_ANNOTATION) {
        return new PsiPerlCommentAnnotationImpl(node);
      }
      ...
      else if (type == CONTINUATION_EXPR) {
        return new PsiPerlContinuationExprImpl(node);
      }
      ...
      else if (type == DEFINED_EXPR) {
        return new PsiPerlDefinedExprImpl(node);
      }
      else if (type == DELETE_EXPR) {
        return new PsiPerlDeleteExprImpl(node);
      }
      else if (type == DEREF_EXPR) {
        return new PsiPerlDerefExprImpl(node);
      }
      else if (type == DO_BLOCK_EXPR) {
        return new PsiPerlDoBlockExprImpl(node);
      }
      else if (type == DO_EXPR) {
        return new PsiPerlDoExprImpl(node);
      }
      else if (type == EACH_EXPR) {
        return new PsiPerlEachExprImpl(node);
      }
      ...
      else if (type == EXCEPT_EXPR) {
        return new PsiPerlExceptExprImpl(node);
      }
      else if (type == EXIT_EXPR) {
        return new PsiPerlExitExprImpl(node);
      }
      else if (type == FILE_READ_EXPR) {
        return new PsiPerlFileReadExprImpl(node);
      }
      else if (type == FINALLY_EXPR) {
        ...
        return new PsiPerlForConditionImpl(node);
      }
      else if (type == FOR_INIT) {
        return new PsiPerlForInitImpl(node);
      }
      else if (type == FOR_MUTATOR) {
        return new PsiPerlForMutatorImpl(node);
      }
      ...
      else if (type == FUN_EXPR) {
        return new PsiPerlFunExprImpl(node);
      }
      ...
      else if (type == HASHREF_TYPE) {
        return new PsiPerlHashrefTypeImpl(node);
      }
      else if (type == HASH_ARRAY_SLICE) {
        return new PsiPerlHashArraySliceImpl(node);
      }
      ...
      else if (type == HASH_HASH_SLICE) {
        return new PsiPerlHashHashSliceImpl(node);
      }
        ...
        return new PsiPerlHeredocImpl(node);
      }
      else if (type == HEREDOC_OPENER) {
        return new PsiPerlHeredocOpenerImpl(node);
      }
      else if (type == HEREDOC_QQ) {
        return new PsiPerlHeredocQqImpl(node);
      }
      else if (type == HEREDOC_QX) {
        return new PsiPerlHeredocQxImpl(node);
      }
        ...
        return new PsiPerlKeysExprImpl(node);
      }
      ...
      else if (type == LP_CODE_BLOCK) {
        return new PsiPerlLpCodeBlockImpl(node);
      }
      else if (type == LP_CODE_BLOCK_WITH_TRYCATCH) {
        return new PsiPerlLpCodeBlockWithTrycatchImpl(node);
      }
      ...
      else if (type == LP_REGEX) {
        return new PsiPerlLpRegexImpl(node);
      }
      else if (type == LP_REGEX_REPLACEMENT) {
        return new PsiPerlLpRegexReplacementImpl(node);
      }
      else if (type == LP_REGEX_X) {
        return new PsiPerlLpRegexXImpl(node);
      }
      else if (type == LP_REGEX_XX) {
        return new PsiPerlLpRegexXxImpl(node);
      }
      else if (type == LP_STRING_Q) {
        return new PsiPerlLpStringQImpl(node);
      }
      else if (type == LP_STRING_QQ) {
        return new PsiPerlLpStringQqImpl(node);
      }
      else if (type == LP_STRING_QW) {
        return new PsiPerlLpStringQwImpl(node);
      }
      else if (type == LP_STRING_QX) {
        return new PsiPerlLpStringQxImpl(node);
      }
        ...
        return new PsiPerlMethodExprImpl(node);
      }
      ...
      else if (type == OTHERWISE_EXPR) {
        return new PsiPerlOtherwiseExprImpl(node);
      }
      else if (type == PACKAGE_EXPR) {
        return new PsiPerlPackageExprImpl(node);
      }
      else if (type == PARENTHESISED_CALL_ARGUMENTS) {
      ...
      else if (type == PARSABLE_STRING_USE_VARS) {
        return new PsiPerlParsableStringUseVarsImpl(node);
      }
      ...
      else if (type == POST_DEREF_ARRAY_SLICE_EXPR) {
        return new PsiPerlPostDerefArraySliceExprImpl(node);
      }
      else if (type == POST_DEREF_EXPR) {
        return new PsiPerlPostDerefExprImpl(node);
      }
      else if (type == POST_DEREF_GLOB_EXPR) {
        return new PsiPerlPostDerefGlobExprImpl(node);
      }
      else if (type == POST_DEREF_HASH_SLICE_EXPR) {
        ...
        return new PsiPerlScalarExprImpl(node);
      }
      ...
      else if (type == SIGNATURE_CONTENT) {
        return new PsiPerlSignatureContentImpl(node);
      }
      else if (type == SIGNATURE_ELEMENT) {
        return new PsiPerlSignatureElementImpl(node);
      }
      else if (type == SORT_EXPR) {
        return new PsiPerlSortExprImpl(node);
      }
      else if (type == SPLICE_EXPR) {
        return new PsiPerlSpliceExprImpl(node);
      }
      ...
      else if (type == SWITCH_COMPOUND) {
        return new PsiPerlSwitchCompoundImpl(node);
      }
      else if (type == SWITCH_CONDITION) {
        return new PsiPerlSwitchConditionImpl(node);
      }
        ...
        return new PsiPerlTernaryExprImpl(node);
      }
      else if (type == TRYCATCH_COMPOUND) {
        return new PsiPerlTrycatchCompoundImpl(node);
      }
      else if (type == TRYCATCH_EXPR) {
        ...
        return new PsiPerlTypeSpecifierImpl(node);
      }
      ...
      else if (type == VALUES_EXPR) {
        return new PsiPerlValuesExprImpl(node);
      }
      else if (type == VARIABLE_DECLARATION_ELEMENT) {
      ...
      else if (type == WANTARRAY_EXPR) {
        return new PsiPerlWantarrayExprImpl(node);
      }
