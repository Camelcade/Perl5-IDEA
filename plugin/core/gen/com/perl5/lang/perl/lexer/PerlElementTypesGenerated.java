...
public interface PerlElementTypesGenerated {
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == ANNOTATION_NO_INJECT) {
        return new PsiPerlAnnotationNoInjectImpl(node);
      }
      ...
      else if (type == BLOCK_ARRAY) {
        return new PsiPerlBlockArrayImpl(node);
      }
      else if (type == BLOCK_BRACELESS) {
        return new PsiPerlBlockBracelessImpl(node);
      }
      else if (type == BLOCK_CODE) {
        return new PsiPerlBlockCodeImpl(node);
      }
      else if (type == BLOCK_COMPOUND) {
        return new PsiPerlBlockCompoundImpl(node);
      }
      else if (type == BLOCK_GLOB) {
        return new PsiPerlBlockGlobImpl(node);
      }
      else if (type == BLOCK_HASH) {
        return new PsiPerlBlockHashImpl(node);
      }
      else if (type == BLOCK_SCALAR) {
        return new PsiPerlBlockScalarImpl(node);
      }
      ...
      else if (type == CUSTOM_ATOM_EXPR) {
        return new PsiPerlCustomAtomExprImpl(node);
      }
      ...
      else if (type == ESC_CHAR) {
        return new PsiPerlEscCharImpl(node);
      }
      ...
      else if (type == FILE_GLOB_EXPR) {
        return new PsiPerlFileGlobExprImpl(node);
      }
      ...
      else if (type == HEX_CHAR) {
        return new PsiPerlHexCharImpl(node);
      }
      ...
      else if (type == ISA_EXPR) {
        return new PsiPerlIsaExprImpl(node);
      }
      ...
      else if (type == OCT_CHAR) {
        return new PsiPerlOctCharImpl(node);
      }
      ...
      else if (type == REGEX_REPLACEMENT) {
        return new PsiPerlRegexReplacementImpl(node);
      }
      ...
      else if (type == UNICODE_CHAR) {
        return new PsiPerlUnicodeCharImpl(node);
      }
