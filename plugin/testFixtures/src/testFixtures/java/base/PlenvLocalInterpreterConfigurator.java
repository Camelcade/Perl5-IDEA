...
class PlenvLocalInterpreterConfigurator extends PerlVersionManagerBasedConfigurator {
  ...
  protected @NotNull PerlRealVersionManagerHandler<?, ?> getVersionManagerHandler() {
    return PlenvTestUtil.getVersionManagerHandler();
  }
  ...
  public String toString() {
    return "plenv: " + getDistributionId();
  }
}
