...
public class PsiPodSectionFormatImpl extends PodCompositeElementMixin implements PsiPodSectionFormat {

  public PsiPodSectionFormatImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitPodSectionFormat(this);
  }
