...
public class PsiHead1SectionContentImpl extends PodCompositeElementMixin implements PsiHead1SectionContent {

  public PsiHead1SectionContentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiPodVisitorGenerated visitor) {
    visitor.visitHead1SectionContent(this);
  }
  ...
  @Override
  @NotNull
  public List<PsiHead2Section> getHead2SectionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PsiHead2Section.class);
  }

  @Override
  @NotNull
  public List<PsiHead3Section> getHead3SectionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PsiHead3Section.class);
  }
