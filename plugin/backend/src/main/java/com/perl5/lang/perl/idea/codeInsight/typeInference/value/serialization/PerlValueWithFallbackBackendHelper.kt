...
class PerlValueWithFallbackBackendHelper : PerlParametrizedOperationValueBackendHelper<PerlValueWithFallback>() {
  override val serializationId: Int
    get() = PerlValueBackendHelper.VALUE_WITH_FALLBACK
