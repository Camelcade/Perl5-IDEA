...
class PerlArithmeticNegationValueBackendHelper : PerlOperationValueBackendHelper<PerlArithmeticNegationValue>() {
  override val serializationId: Int
    get() = PerlValueBackendHelper.ARITHMETIC_NEGATION
