...
import com.perl5.lang.perl.idea.codeInsight.typeInference.value.PerlReferenceValue
import com.perl5.lang.perl.idea.codeInsight.typeInference.value.PerlValue
import com.perl5.lang.perl.idea.codeInsight.typeInference.value.PerlValueDeserializer

class PerlReferenceValueSerializationHelper : PerlParametrizedOperationValueSerializationHelper<PerlReferenceValue>() {
  override val serializationId: Int
    get() = PerlValueSerializationHelper.REFERENCE_ID

  override fun deserialize(deserializer: PerlValueDeserializer, baseValue: PerlValue, parameter: PerlValue): PerlValue =
    PerlReferenceValue.create(baseValue, parameter)
}