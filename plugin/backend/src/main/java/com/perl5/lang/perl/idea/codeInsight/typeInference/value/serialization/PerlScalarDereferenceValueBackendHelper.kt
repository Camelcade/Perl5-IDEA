...
class PerlScalarDereferenceValueBackendHelper : PerlOperationValueBackendHelper<PerlScalarDereferenceValue>() {
  override val serializationId: Int
    get() = PerlValueBackendHelper.SCALAR_DEREFERENCE_ID
