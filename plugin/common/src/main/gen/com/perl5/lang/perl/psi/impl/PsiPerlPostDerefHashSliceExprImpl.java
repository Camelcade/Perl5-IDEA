...
public class PsiPerlPostDerefHashSliceExprImpl extends PsiPerlExprImpl implements PsiPerlPostDerefHashSliceExpr {

  public PsiPerlPostDerefHashSliceExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitPostDerefHashSliceExpr(this);
  }
