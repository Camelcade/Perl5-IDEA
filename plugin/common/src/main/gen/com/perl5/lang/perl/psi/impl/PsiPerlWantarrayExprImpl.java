...
public class PsiPerlWantarrayExprImpl extends PsiPerlExprImpl implements PsiPerlWantarrayExpr {

  public PsiPerlWantarrayExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull PsiPerlVisitor visitor) {
    visitor.visitWantarrayExpr(this);
  }
