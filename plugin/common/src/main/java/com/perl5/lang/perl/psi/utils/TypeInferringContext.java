...
import static com.perl5.lang.perl.psi.utils.PerlResolveUtilCore.computeStopElement;
...
class TypeInferringContext {
  ...
  public TypeInferringContext(@NotNull PerlVariable variable) {
    ...
    myLexicalDeclaration = PerlResolveUtilCore.getLexicalDeclaration(variable);
  ...
  public @NotNull PerlValue buildValue() {
    return PerlValue.isDuckTypingEnabled() ? PerlValueWithFallback.create(myValueBuilder.build(), myDuckValueBuilder.build())
