...
public final class PerlSharedSettings implements PersistentStateComponent<PerlSharedSettings> {
  ...
  public PerlSharedSettings(Project project) {
    myProject = project;
    setWarningsProviders(ContainerUtil.concat(PerlStrictWarningsDefaults.DEFAULT_STRICT_AND_WARNINGS_PROVIDERS, PerlStrictWarningsDefaults.DEFAULT_WARNINGS_ONLY_PROVIDERS));
    setStrictProviders(ContainerUtil.concat(PerlStrictWarningsDefaults.DEFAULT_STRICT_AND_WARNINGS_PROVIDERS, PerlStrictWarningsDefaults.DEFAULT_STRICT_ONLY_PROVIDERS));
  }
