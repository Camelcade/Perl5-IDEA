...
public final class PerlHashUtilCore {
  ...
  private static final TokenSet COLLAPSED_LISTS = TokenSet.create(
    PerlElementTypesGenerated.ARRAY_VARIABLE, PerlElementTypesGenerated.HASH_VARIABLE, PerlElementTypesGenerated.ARRAY_CAST_EXPR, PerlElementTypesGenerated.HASH_CAST_EXPR
  );
