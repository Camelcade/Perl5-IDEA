...
public class PerlParserImpl extends PerlParserGenerated {
  ...
  public @NotNull TokenSet getBadCharacterForbiddenTokens() {
    return PerlParserTokenSets.BAD_CHARACTER_FORBIDDEN_TOKENS;
  }

  public @NotNull TokenSet getConsumableSemicolonTokens() {
    return PerlParserTokenSets.CONSUMABLE_SEMI_TOKENS;
  }

  public @NotNull TokenSet getUnconsumableSemicolonTokens() {
    return PerlParserTokenSets.UNCONSUMABLE_SEMI_TOKENS;
  }
