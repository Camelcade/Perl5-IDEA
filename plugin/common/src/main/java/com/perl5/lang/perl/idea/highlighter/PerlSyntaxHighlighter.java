...
import static com.perl5.lang.perl.parser.PerlElementTypesGenerated.REGEX_QUOTE_OPEN;

public class PerlSyntaxHighlighter extends SyntaxHighlighterBase {
  public static final TextAttributesKey EMBED_MARKER_KEY =
  ...
  public static final TextAttributesKey PERL_SUB_DEFINITION =
    createTextAttributesKey("PERL_SUB_DEFINITION", DefaultLanguageHighlighterColors.FUNCTION_DECLARATION);
  ...
  public static final TextAttributesKey PERL_BLOCK_NAME =
    createTextAttributesKey("PERL_BLOCK_NAME", DefaultLanguageHighlighterColors.PREDEFINED_SYMBOL);
  ...
  public static final TextAttributesKey PERL_OPERATOR =
    createTextAttributesKey("PERL_OPERATOR", DefaultLanguageHighlighterColors.OPERATION_SIGN);
  public static final TextAttributesKey PERL_DEREFERENCE =
    createTextAttributesKey("PERL_DEREFERENCE", DefaultLanguageHighlighterColors.OPERATION_SIGN);

  public static final TextAttributesKey PERL_REGEX_QUOTE =
    createTextAttributesKey("PERL_REGEX_QUOTE", DefaultLanguageHighlighterColors.BRACKETS);
  public static final TextAttributesKey PERL_REGEX_TOKEN =
    createTextAttributesKey("PERL_REGEX_TOKEN", DefaultLanguageHighlighterColors.STRING);
  ...
  public static final TextAttributesKey PERL_ANNOTATION =
    createTextAttributesKey("PERL_ANNOTATION", DefaultLanguageHighlighterColors.METADATA);
  ...
  public static final TextAttributesKey PERL_SEMICOLON =
    createTextAttributesKey("PERL_SEMICOLON", DefaultLanguageHighlighterColors.SEMICOLON);
  ...
  public static final TextAttributesKey PERL_PAREN =
  ...
  public static final TextAttributesKey PERL_AUTOLOAD =
    createTextAttributesKey("PERL_AUTOLOAD", TemplateColors.TEMPLATE_VARIABLE_ATTRIBUTES);
  ...
  static {
    ...
    safeMap(PERL_SCALAR, SIGIL_SCALAR, LEFT_BRACE_SCALAR, RIGHT_BRACE_SCALAR, DEREF_SCALAR, SIGIL_SCALAR_INDEX, DEREF_SCALAR_INDEX,
            SCALAR_NAME, ANNOTATION_SCALAR);
    safeMap(PERL_ARRAY, SIGIL_ARRAY, LEFT_BRACE_ARRAY, RIGHT_BRACE_ARRAY, DEREF_ARRAY, ARRAY_NAME, ANNOTATION_ARRAY);
    safeMap(PERL_HASH, SIGIL_HASH, LEFT_BRACE_HASH, RIGHT_BRACE_HASH, DEREF_HASH, HASH_NAME, ANNOTATION_HASH);
    ...
    safeMap(STRING_CHAR_NAME, PERL_STRING_CHAR_NAME);
