...
public final class PerlResolveUtilCore {
  private static final Logger LOG = Logger.getInstance(PerlResolveUtilCore.class);
  ...
  private static final PsiCacheKey<PerlVariableDeclarationElement, PerlVariable> DECLARATION_KEY = PsiCacheKey.create(
    "perl5.variable.declaration", variable -> {
      ...
      if (PerlResolveUtilCore.treeWalkUp(variable, variableProcessor)) {
