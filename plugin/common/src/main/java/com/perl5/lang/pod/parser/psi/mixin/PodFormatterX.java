...
public class PodFormatterX extends PodStubBasedTitledSection implements PodFormatter {
  public PodFormatterX(@NotNull PodSectionStub stub, @NotNull IElementType nodeType) {
    super(stub, nodeType);
  }
  ...
  public PsiElement setName(@NonNls @NotNull String name) throws IncorrectOperationException {
    ...
    ElementManipulators.getManipulator(nameIdentifier).handleContentChange(
      nameIdentifier, PodRenderUtil.escapeTitle(PodElementFactory.getHeaderText(getProject(), name)));
    return this;
  }
