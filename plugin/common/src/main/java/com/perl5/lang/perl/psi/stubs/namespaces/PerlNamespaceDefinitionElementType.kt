...
open class PerlNamespaceDefinitionElementType : IElementType, PsiElementProvider {
  ...
  override fun getPsiElement(node: ASTNode): PsiElement = PsiPerlNamespaceDefinitionImpl(node)
}
