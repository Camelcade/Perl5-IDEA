...
project(":plugin.backend").projectDir = file("plugin/core")
...
project(":lang.tt2.backend").projectDir = file("tt2/core")
...
project(":lang.mojo.backend").projectDir = file("mojo/core")
...
project(":lang.embedded.backend").projectDir = file("embedded/core")
...
project(":lang.mason.mason2.backend").projectDir = file("mason/mason2/core")
...
project(":lang.mason.htmlmason.backend").projectDir = file("mason/htmlmason/core")
