...
project(":plugin.backend").projectDir = file("plugin/backend")
...
include(":plugin.cpanminus.backend")
project(":plugin.cpanminus.backend").projectDir = file("plugin/cpanminus/backend")
include(":plugin.cpanminus.common")
project(":plugin.cpanminus.common").projectDir = file("plugin/cpanminus/common")
include(":plugin.profiler")
project(":plugin.profiler").projectDir = file("plugin/profiler")
include(":plugin.structureView")
project(":plugin.structureView").projectDir = file("plugin/structureView")
...
include("lang.tt2.backend")
project(":lang.tt2.backend").projectDir = file("tt2/backend")
...
include(":lang.mojo.backend")
project(":lang.mojo.backend").projectDir = file("mojo/backend")
...
include(":lang.mojo.structureView")
project(":lang.mojo.structureView").projectDir = file("mojo/structureView")
...
include(":lang.embedded.backend")
project(":lang.embedded.backend").projectDir = file("embedded/backend")
...
include(":lang.embedded.structureView")
project(":lang.embedded.structureView").projectDir = file("embedded/structureView")
include("lang.mason.framework")
project(":lang.mason.framework").projectDir = file("mason/framework")
include(":lang.mason.framework.common")
project(":lang.mason.framework.common").projectDir = file("mason/framework/common")
include(":lang.mason.framework.backend")
project(":lang.mason.framework.backend").projectDir = file("mason/framework/backend")
include(":lang.mason.framework.frontend")
project(":lang.mason.framework.frontend").projectDir = file("mason/framework/frontend")
include(":lang.mason.framework.frontend.split")
project(":lang.mason.framework.frontend.split").projectDir = file("mason/framework/frontend/split")
...
include(":lang.mason.mason2.backend")
project(":lang.mason.mason2.backend").projectDir = file("mason/mason2/backend")
...
include(":lang.mason.mason2.structureView")
project(":lang.mason.mason2.structureView").projectDir = file("mason/mason2/structureView")
...
include(":lang.mason.htmlmason.backend")
project(":lang.mason.htmlmason.backend").projectDir = file("mason/htmlmason/backend")
...
include(":lang.mason.htmlmason.structureView")
project(":lang.mason.htmlmason.structureView").projectDir = file("mason/htmlmason/structureView")
