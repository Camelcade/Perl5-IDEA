...
tasks {
  val generateHTMLMasonLexer by registering(GenerateLexerTask::class) {
    sourceFile = file("grammar/HTMLMason.flex")
    targetOutputDir = file("src/main/gen/com/perl5/lang/htmlmason/lexer/")
