...
public class HTMLMasonFormattingModelBuilder extends PerlTemplatingFormattingModelBuilder {
  @Override
  public @NotNull FormattingModel createModel(@NotNull PsiElement element,
    ...
    PerlFormattingBlock block = new HTMLMasonFormattingBlock(
      element.getNode(), new HTMLMasonFormattingContext(element, element.getTextRange(), settings,
                                                        mode));
