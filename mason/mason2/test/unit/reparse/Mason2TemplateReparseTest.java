...
public class Mason2TemplateReparseTest extends Mason2TopLevelComponentTestCase {
  @Override
  protected String getBaseDataPath() {
    return "testData/unit/template/reparse";
  }
  ...
  @Test
  public void testTemplateBottomClose() {doTest("<%perl>");}

  @Test
  public void testTemplateMid() {doTest("edit");}

  @Test
  public void testTemplateMidClose() {doTest("<%perl>");}

  @Test
  public void testTemplateTop() {doTest("edit");}

  @Test
  public void testTemplateTopClose() {doTest("<%perl>");}
