...
public class MasonParentNamespacesStubIndex extends PerlStubIndexBase<MasonNamespaceDefinition> {
  ...
  public static @NotNull MasonParentNamespacesStubIndex getInstance() {
    return StubIndexExtension.EP_NAME.findExtensionOrFail(MasonParentNamespacesStubIndex.class);
  }
}