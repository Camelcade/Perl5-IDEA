...
class MasonNamespaceElementType(name: String) : PerlNamespaceDefinitionElementType(name, Mason2Language.INSTANCE), PsiElementProvider {
  override fun getPsiElement(node: ASTNode): PsiElement = MasonNamespaceDefinitionImpl(node)
}
