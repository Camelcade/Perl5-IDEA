...
NAMED_UNARY_OPERATORS = "scalar"|"umask"|"srand"|"sleep"|"shift"|"setservent"|"setprotoent"|"setnetent"|"sethostent"|"reset"|"readline"|"rand"|"prototype"|"pop"|"localtime"|"gmtime"|"getsockname"|"getpwuid"|"getpwnam"|"getprotobyname"|"getpgrp"|"getpeername"|"getnetbyname"|"gethostbyname"|"getgrnam"|"getgrgid"|"exit"|"exists"|"caller"
...
%xstate SKIP_COMMENTS_AND_SPACES
...
<AFTER_TRY,AFTER_CATCH,AFTER_FINALLY,BEFORE_CATCH_BLOCK,CATCH_PACKAGE,BEFORE_WITH,
  AFTER_EXCEPT, AFTER_CONTINUATION,  AFTER_OTHERWISE, AFTER_OTHERWISE_BLOCK, SKIP_COMMENTS_AND_SPACES
  >{
  {NEW_LINE}   				{return getNewLineToken();}
  {WHITE_SPACE}+  			{return TokenType.WHITE_SPACE;}
  {LINE_COMMENT}			{return COMMENT_LINE;}
...
<AFTER_TRY_BLOCK,AFTER_CATCH_BLOCK,AFTER_FINALLY_BLOCK,AFTER_EXCEPT_BLOCK,AFTER_OTHERWISE_BLOCK,AFTER_CONTINUATION_BLOCK>{
  {SPACE_OR_COMMENT}+ / ("catch"|except|otherwise|finally|continuation) {pushback();pushStateAndBegin(SKIP_COMMENTS_AND_SPACES);}
  ...
  [^]            {afterTryCatchFallback();if(hasTryCatch()) return SEMICOLON;}
}
...
<SKIP_COMMENTS_AND_SPACES>  [^] {yypushback(1);popState();}
