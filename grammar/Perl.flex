...
<LEX_SCALAR_NAME>{
	"{" / {BRACED_VARIABLE_TAIL}	{yybegin(LEX_SCALAR_NAME_BRACED);return LEFT_BRACE;}
	{VARIABLE_NAME}					{popState(); return SCALAR_NAME;}
}
<LEX_SCALAR_NAME_BRACED> {VARIABLE_NAME}				{return SCALAR_NAME;}

<LEX_ARRAY_NAME>{
	"{" / {BRACED_VARIABLE_TAIL}	{yybegin(LEX_ARRAY_NAME_BRACED);return LEFT_BRACE;}
	{VARIABLE_NAME}					{popState(); return ARRAY_NAME;}
}
<LEX_ARRAY_NAME_BRACED>	{VARIABLE_NAME}					{return ARRAY_NAME;}

<LEX_HASH_NAME>{
	"{" / {BRACED_VARIABLE_TAIL}	{yybegin(LEX_HASH_NAME_BRACED);return LEFT_BRACE;}
	{VARIABLE_NAME}					{popState(); return HASH_NAME;}
}
<LEX_HASH_NAME_BRACED>	{VARIABLE_NAME}					{return HASH_NAME;}

<LEX_GLOB_NAME>{
	"{" / {BRACED_VARIABLE_TAIL}	{yybegin(LEX_GLOB_NAME_BRACED);return LEFT_BRACE;}
	{VARIABLE_NAME}					{popState(); return GLOB_NAME;}
}
<LEX_GLOB_NAME_BRACED>	{VARIABLE_NAME}					{return GLOB_NAME;}

<LEX_CODE_NAME>{
	"{" / {BRACED_VARIABLE_TAIL}	{yybegin(LEX_CODE_NAME_BRACED);return LEFT_BRACE;}
