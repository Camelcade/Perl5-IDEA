...
%xstate ANNOTATION,ANNOTATION_KEY,ANNOTATION_PACKAGE,ANNOTATION_PACKAGE_RETURNS,ANNOTATION_STRING,ANNOTATION_FALLBACK
...
<ANNOTATION_STRING,ANNOTATION_PACKAGE,ANNOTATION_PACKAGE_RETURNS>
{
	{WHITE_SPACE}+			{return TokenType.WHITE_SPACE;}
}

<ANNOTATION_PACKAGE,ANNOTATION_PACKAGE_RETURNS>{
	{QUALIFIED_IDENTIFIER}	{yybegin(ANNOTATION_FALLBACK);return PACKAGE;}
}
<ANNOTATION_PACKAGE_RETURNS>{
...
<ANNOTATION,ANNOTATION_PACKAGE,ANNOTATION_PACKAGE_RETURNS,ANNOTATION_KEY,ANNOTATION_STRING>
{
