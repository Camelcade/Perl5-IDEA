...
package com.perl5.compat.parser;
...
public class GeneratedParserUtilBase
{
	...
	public static final IElementType DUMMY_BLOCK = new com.perl5.compat.parser.GeneratedParserUtilBase.DummyBlockElementType();
	public static final com.perl5.compat.parser.GeneratedParserUtilBase.Parser TOKEN_ADVANCER = new com.perl5.compat.parser.GeneratedParserUtilBase.Parser()
	{
		@Override
	...
	public static final com.perl5.compat.parser.GeneratedParserUtilBase.Parser TRUE_CONDITION = new com.perl5.compat.parser.GeneratedParserUtilBase.Parser()
	{
		@Override
		public boolean parse(PsiBuilder builder, int level)
		{
	...
	public static final Key<com.perl5.compat.parser.GeneratedParserUtilBase.CompletionState> COMPLETION_STATE_KEY = Key.create("COMPLETION_STATE_KEY");
	...
	public static boolean invalid_left_marker_guard_(PsiBuilder builder, PsiBuilder.Marker marker, String funcName)
	{
		...
		com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state = com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder);
	...
	private static boolean consumeTokens(PsiBuilder builder, boolean smart, int pin, IElementType... tokens)
	{
		...
		com.perl5.compat.parser.GeneratedParserUtilBase.CompletionState completionState = state.completionState;
		...
		for (int i = 0, tokensLength = tokens.length; i < tokensLength; i++)
		{
			...
			if (result || pinned)
			{
				...
				if (!(fast ? consumeTokenFast(builder, tokens[i]) : consumeToken(builder, tokens[i])))
				{
					...
					if (pin < 0 || pinned)
					{
						report_error_(builder, state, false);
					}
				}
			}
		}
	...
	{
		return consumeToken(builder, text, com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder).caseSensitive);
	}
	...
	{
		int count = nextTokenIsFast(builder, text, com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder).caseSensitive);
		if (count > 0)
		{
			while (count-- > 0)
			{
	...
	{
		return nextTokenIsFast(builder, token) || com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder).completionState != null;
	}

	public static boolean nextTokenIsSmart(PsiBuilder builder, IElementType... tokens)
	{
		return nextTokenIsFast(builder, tokens) || com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder).completionState != null;
	}
	...
	{
		if (!addVariantSmart(builder, token, false))
		{
			return true;
		}
	...
	{
		if (!addVariantSmart(builder, tokenText, false))
		{
			return true;
		}
		return nextTokenIsFast(builder, tokenText, com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder).caseSensitive) > 0;
	}
	...
	{
		addVariant(builder, com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder), text);
	}

	private static void addVariant(PsiBuilder builder, com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state, Object o)
	{
	...
	private static void addVariantInner(com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state, int pos, Object o)
	{
		com.perl5.compat.parser.GeneratedParserUtilBase.Variant variant = state.VARIANTS.alloc().init(pos, o);
	...
	private static void addCompletionVariant(@NotNull PsiBuilder builder, @NotNull com.perl5.compat.parser.GeneratedParserUtilBase.CompletionState completionState, Object o)
	{
		int offset = builder.getCurrentOffset();
	...
	{
		return ((PsiBuilderImpl) ((com.perl5.compat.parser.GeneratedParserUtilBase.Builder) builder).getDelegate()).whitespaceOrComment(type);
	}
	...
	public static void exit_section_(PsiBuilder builder,
									 ...
									 boolean result)
	{
		close_marker_impl_(com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder).currentFrame, marker, elementType, result);
	}
	...
	{
		com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state = com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder);
		com.perl5.compat.parser.GeneratedParserUtilBase.Frame frame = state.FRAMES.alloc().init(builder, state, level, modifiers, elementType, frameName);
		com.perl5.compat.parser.GeneratedParserUtilBase.Frame prevFrame = state.currentFrame;
	...
	public static void exit_section_(PsiBuilder builder,
									 ...
									 boolean result,
									 boolean pinned,
									 @Nullable com.perl5.compat.parser.GeneratedParserUtilBase.Parser eatMore)
	{
									 ...
									 @Nullable com.perl5.compat.parser.GeneratedParserUtilBase.Parser eatMore)
	{
		...
		com.perl5.compat.parser.GeneratedParserUtilBase.Frame frame = state.currentFrame;
	...
	private static void exit_section_impl_(com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state,
										   com.perl5.compat.parser.GeneratedParserUtilBase.Frame frame,
										   PsiBuilder builder,
										   @Nullable IElementType elementType,
										   boolean result,
										   boolean pinned,
										   @Nullable com.perl5.compat.parser.GeneratedParserUtilBase.Parser eatMore)
	{
		...
		com.perl5.compat.parser.GeneratedParserUtilBase.Frame prevFrame = willFail && eatMore == null ? null : state.currentFrame;
	...
	private static void close_frame_impl_(com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state,
										  com.perl5.compat.parser.GeneratedParserUtilBase.Frame frame,
										  PsiBuilder builder,
										  PsiBuilder.Marker marker,
										  ...
										  boolean pinned)
	{
		if (elementType != null && marker != null)
		{
			...
			if (result || pinned)
			{
				...
				{
					marker.drop();
					for (com.perl5.compat.parser.GeneratedParserUtilBase.Frame f = frame.parentFrame; f != null; f = f.parentFrame)
					{
	...
	private static void close_marker_impl_(com.perl5.compat.parser.GeneratedParserUtilBase.Frame frame, PsiBuilder.Marker marker, IElementType elementType, boolean result)
	{
		if (marker == null)
		{
			return;
	...
	public static boolean report_error_(PsiBuilder builder, boolean result)
	{
		if (!result)
		{
			report_error_(builder, com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder), false);
		}
		return result;
	}

	public static void report_error_(PsiBuilder builder, com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state, boolean advance)
	{
		com.perl5.compat.parser.GeneratedParserUtilBase.Frame frame = state.currentFrame;
		if (frame == null)
		{
	...
	public static boolean withProtectedLastVariantPos(PsiBuilder builder, int level, com.perl5.compat.parser.GeneratedParserUtilBase.Parser parser)
	{
		com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state = com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.get(builder);
	...
	private static int getLastVariantPos(com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state, int defValue)
	{
	...
	private static boolean reportError(PsiBuilder builder,
									   com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state,
									   com.perl5.compat.parser.GeneratedParserUtilBase.Frame frame,
									   IElementType elementType,
									   boolean force,
									   boolean advance)
	...
	{
		com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state = new com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState();
		com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState.initState(state, builder, root, extendsSets);
		return new com.perl5.compat.parser.GeneratedParserUtilBase.Builder(builder, state, parser);
	}

	public static boolean parseAsTree(com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state, final PsiBuilder builder, int level, final IElementType chunkType,
									  boolean checkBraces, final com.perl5.compat.parser.GeneratedParserUtilBase.Parser parser, final com.perl5.compat.parser.GeneratedParserUtilBase.Parser eatMoreCondition)
	{
	...
	{
		public final com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state;
		public final PsiParser parser;

		public Builder(PsiBuilder builder, com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state_, PsiParser parser_)
		{
			super(builder);
			state = state_;
			parser = parser_;
	...
	{
		final LimitedPool<com.perl5.compat.parser.GeneratedParserUtilBase.Variant> VARIANTS = new LimitedPool<com.perl5.compat.parser.GeneratedParserUtilBase.Variant>(VARIANTS_POOL_SIZE, new LimitedPool.ObjectFactory<com.perl5.compat.parser.GeneratedParserUtilBase.Variant>()
		{
			@NotNull
			@Override
			public com.perl5.compat.parser.GeneratedParserUtilBase.Variant create()
			{
				return new com.perl5.compat.parser.GeneratedParserUtilBase.Variant();
			}

			@Override
			public void cleanup(@NotNull com.perl5.compat.parser.GeneratedParserUtilBase.Variant o)
			{
			}
		});
		final LimitedPool<com.perl5.compat.parser.GeneratedParserUtilBase.Frame> FRAMES = new LimitedPool<com.perl5.compat.parser.GeneratedParserUtilBase.Frame>(FRAMES_POOL_SIZE, new LimitedPool.ObjectFactory<com.perl5.compat.parser.GeneratedParserUtilBase.Frame>()
		{
			@NotNull
			@Override
			public com.perl5.compat.parser.GeneratedParserUtilBase.Frame create()
			{
				return new com.perl5.compat.parser.GeneratedParserUtilBase.Frame();
			}

			@Override
			public void cleanup(@NotNull com.perl5.compat.parser.GeneratedParserUtilBase.Frame o)
			{
			}
		});
		public PairProcessor<IElementType, IElementType> altExtendsChecker;
		public com.perl5.compat.parser.GeneratedParserUtilBase.Frame currentFrame;
		public com.perl5.compat.parser.GeneratedParserUtilBase.CompletionState completionState;
		...
		com.perl5.compat.parser.GeneratedParserUtilBase.MyList<com.perl5.compat.parser.GeneratedParserUtilBase.Variant> variants = new com.perl5.compat.parser.GeneratedParserUtilBase.MyList<com.perl5.compat.parser.GeneratedParserUtilBase.Variant>(INITIAL_VARIANTS_SIZE);
		com.perl5.compat.parser.GeneratedParserUtilBase.MyList<com.perl5.compat.parser.GeneratedParserUtilBase.Variant> unexpected = new com.perl5.compat.parser.GeneratedParserUtilBase.MyList<com.perl5.compat.parser.GeneratedParserUtilBase.Variant>(INITIAL_VARIANTS_SIZE / 10);
		private boolean caseSensitive;

		public static com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState get(PsiBuilder builder)
		{
			return ((com.perl5.compat.parser.GeneratedParserUtilBase.Builder) builder).state;
		}

		public static void initState(com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state, PsiBuilder builder, IElementType root, TokenSet[] extendsSets)
		{
		...
		{
			com.perl5.compat.parser.GeneratedParserUtilBase.MyList<com.perl5.compat.parser.GeneratedParserUtilBase.Variant> list = expected ? variants : unexpected;
			String[] strings = new String[list.size()];
			long[] hashes = new long[strings.length];
			Arrays.fill(strings, "");
			int count = 0;
			loop:
			for (com.perl5.compat.parser.GeneratedParserUtilBase.Variant variant : list)
			{
		...
		public void clearVariants(com.perl5.compat.parser.GeneratedParserUtilBase.Frame frame)
		{
	...
	{
		public com.perl5.compat.parser.GeneratedParserUtilBase.Frame parentFrame;
		...
		public com.perl5.compat.parser.GeneratedParserUtilBase.Frame init(PsiBuilder builder,
																		  com.perl5.compat.parser.GeneratedParserUtilBase.ErrorState state,
																		  int level_,
																		  int modifiers_,
	...
	private static class Variant
	{
		...
		public com.perl5.compat.parser.GeneratedParserUtilBase.Variant init(int pos, Object o)
		{
			position = pos;
			object = o;
			return this;
		...
		public boolean equals(Object o)
		{
			...
			com.perl5.compat.parser.GeneratedParserUtilBase.Variant variant = (com.perl5.compat.parser.GeneratedParserUtilBase.Variant) o;
	...
	private static class DummyBlockElementType extends IElementType implements ICompositeElementType
	{
		...
		{
			return new com.perl5.compat.parser.GeneratedParserUtilBase.DummyBlock();
		}
	}
