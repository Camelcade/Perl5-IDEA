 ...
 */
public class MasonPerlSyntaxHighlighter extends PerlSyntaxHighlighterEmbedded implements MasonPerlElementTypes
{
	...
	{
		return new MasonPerlLexerAdapter(myProject);
	}
