 ...
 */
public class PerlExternalAnnotationsAnnotator extends PerlAnnotator implements PerlExternalAnnotationsElementTypes
{
	@Override
	public void annotate(@NotNull PsiElement element, @NotNull AnnotationHolder holder)
	{
		if (PsiUtilCore.getElementType(element) == PSEUDO_SUB_NAME)
		{
