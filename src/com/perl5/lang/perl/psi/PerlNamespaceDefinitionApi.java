 ...
 */
public interface PerlNamespaceDefinitionApi extends PerlDeprecatable {
  @NotNull
  @Contract(pure = true)
  ...
  default List<PerlNamespaceDefinition> getParentNamespaceDefinitions() {
    return PerlPackageUtil.collectNamespaceDefinitions(getProject(), getParentNamespacesNames());
  }

  @NotNull
  default List<PerlNamespaceDefinition> getChildNamespaceDefinitions() {
