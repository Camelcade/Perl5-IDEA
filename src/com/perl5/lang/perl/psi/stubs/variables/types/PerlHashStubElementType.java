...
import com.perl5.lang.perl.psi.impl.PsiPerlPerlHashImpl;
 ...
 */
public class PerlHashStubElementType extends PerlVariableStubElementType
{
	public PerlHashStubElementType(@NotNull String debugName)
	{
		super(debugName);
	}
	...
	{
		return new PsiPerlPerlHashImpl(stub,this);
	}
