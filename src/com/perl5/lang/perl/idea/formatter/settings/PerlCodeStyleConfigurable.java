...
public class PerlCodeStyleConfigurable extends CodeStyleAbstractConfigurable
{
	...
	{
		return new Perl5CodeStyleMainPanel(getCurrentSettings(), settings);
	}
	...
	private static class Perl5CodeStyleMainPanel extends TabbedLanguageCodeStylePanel
	{
		private Perl5CodeStyleMainPanel(CodeStyleSettings currentSettings, CodeStyleSettings settings)
		{
