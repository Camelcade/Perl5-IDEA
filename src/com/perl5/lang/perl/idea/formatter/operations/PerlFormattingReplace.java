...
public class PerlFormattingReplace implements PerlFormattingOperation {
  ...
  public PerlFormattingReplace(@NotNull PsiElement mySourceFromElement,
                               @NotNull PsiElement mySourceToElement,
                               @NotNull PsiElement myTargetFromElement,
                               @NotNull PsiElement myTargetToElement) {
    assert mySourceFromElement.getParent() == mySourceToElement.getParent() : "Source PSI elements range must be under same parent";
    assert mySourceFromElement.getStartOffsetInParent() <=
           mySourceToElement.getStartOffsetInParent() : "Source from element must come first";
    ...
    assert myTargetFromElement.getStartOffsetInParent() <=
           myTargetToElement.getStartOffsetInParent() : "Targtet from element must come first";
