...
public class PerlExtractMethod {
   ...
   */
  public List<String> getOuterVariablesModified() {
    String reg = "[@%](.*)";
  ...
  public PerlExtractMethod(String codeSelection) {
  ...
  public String buildMethod(@NotNull String methodName,
    ...
    if (methodParameters != null) {
      // Make sure we are passing in parameters
      for (AbstractVariableData mp : methodParameters) {
        if (mp.passAsParameter) {
