...
public class PerlVariableFilter implements Filter
{
	...
	{
		return !(treeElement instanceof PerlVariableStructureViewElement || treeElement instanceof PerlGlobStructureViewElement);
	}
	...
	{
		return new ActionPresentationData("Show variables", null, PerlIcons.GLOB_GUTTER_ICON);
	}
