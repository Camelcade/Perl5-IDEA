	...
	public void projectOpened()
	{
		...
		if (settings.shouldShowAnnounce())
		{
			...
			Notification notification = group.createNotification(
					...
					"<p>This is a fixing update for 2.0 release. Fixes few bugs and adds few minor features. <b>Don't forget to update</b> <code>Devel::Camelcadedb</code> from CPAN to use new debugger features.</p><br/>" +
