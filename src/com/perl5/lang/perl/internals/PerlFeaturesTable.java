...
public class PerlFeaturesTable implements Cloneable {
  ...
  static {
    ...
    AVAILABLE_FEATURES.put("lexical_subs",
                           "v5.18, enables declaration of subroutines via my sub foo, state sub foo and our sub foo syntax. Requires no warnings \"experimental::lexical_subs\"");
    ...
    AVAILABLE_FEATURES
      .put("postderef", "v5.20, allows the use of postfix dereference syntax. Requires no warnings \"experimental::postderef\"");
