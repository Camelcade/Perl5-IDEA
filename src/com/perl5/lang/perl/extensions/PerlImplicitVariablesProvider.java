...
{
	/**
	 * Checks if provider knows this variable
	 *
	 * @param variable PerlVariable element
	 * @return check result
	 */
	boolean isKnownVariable(@NotNull PerlVariable variable);
	 ...
	 */
	@NotNull
	List<String> getFullQualifiedVariablesList();
}
