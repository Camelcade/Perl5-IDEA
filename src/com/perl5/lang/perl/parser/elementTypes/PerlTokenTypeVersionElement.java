 ...
 */
public class PerlTokenTypeVersionElement extends PerlTokenType implements ILeafElementType
{
	public PerlTokenTypeVersionElement(@NotNull @NonNls String debugName)
	{
		super(debugName);
	}
