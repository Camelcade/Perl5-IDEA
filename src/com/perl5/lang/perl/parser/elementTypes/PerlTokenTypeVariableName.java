 ...
 */
public class PerlTokenTypeVariableName extends PerlTokenType implements ILeafElementType
{
	public PerlTokenTypeVariableName(@NotNull @NonNls String debugName)
	{
		super(debugName);
	}
