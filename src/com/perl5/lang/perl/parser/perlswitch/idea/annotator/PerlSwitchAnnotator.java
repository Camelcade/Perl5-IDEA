...
import com.perl5.lang.perl.parser.PerlSwitchPerlParserExtensionImpl;
...
public class PerlSwitchAnnotator extends PerlAnnotator
{
	...
	{
		if (PerlSwitchPerlParserExtensionImpl.getTokenSet().contains(element.getNode().getElementType()))
