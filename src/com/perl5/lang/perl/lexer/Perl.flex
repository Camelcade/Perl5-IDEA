...
%xstate LEX_QUOTE_LIKE_OPENER, LEX_QUOTE_LIKE_OPENER_QQ, LEX_QUOTE_LIKE_CHARS, LEX_QUOTE_LIKE_CHARS_QQ, LEX_QUOTE_LIKE_CLOSER
...
/**
    qq qx q
**/
<LEX_QUOTE_LIKE_OPENER,LEX_QUOTE_LIKE_OPENER_QQ>{
    {EMPTY_SPACE}+  {return processOpenerWhiteSpace();}
    .   {
