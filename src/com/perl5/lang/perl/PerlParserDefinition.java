...
public class PerlParserDefinition implements ParserDefinition, PerlElementTypes
{
	...
	public static final TokenSet COMMENTS = TokenSet.create(PERL_COMMENT, PERL_COMMENT_BLOCK, PERL_POD, PERL_STRING_MULTILINE,PERL_STRING_MULTILINE_END,EMBED_MARKER,TEMPLATE_BLOCK_HTML,TEMPLATE_BLOCK_SQL);
	public static final TokenSet WHITE_SPACE_AND_COMMENTS = TokenSet.orSet(WHITE_SPACES,COMMENTS);

	public static final TokenSet LITERALS = TokenSet.create(PERL_STRING_CONTENT,PERL_STRING_MULTILINE);
