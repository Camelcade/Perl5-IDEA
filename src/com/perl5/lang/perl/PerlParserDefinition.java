...
public class PerlParserDefinition implements ParserDefinition, PerlElementTypes
{
	...
	public static final TokenSet COMMENTS = TokenSet.create(PERL_COMMENT, PERL_COMMENT_BLOCK, PERL_POD, PERL_STRING_MULTILINE,PERL_STRING_MULTILINE_END,TEMPLATE_BLOCK_HTML,TEMPLATE_BLOCK_SQL);
