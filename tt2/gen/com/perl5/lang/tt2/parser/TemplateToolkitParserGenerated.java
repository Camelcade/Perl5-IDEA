...
public class TemplateToolkitParserGenerated implements PsiParser, LightPsiParser {
  ...
  static boolean array_expr_content(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, true, false, recover_array_content_parser_);
    return true;
  }
  ...
  static boolean call_arguments_content(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, result_, false, recover_parenthesised_item_parser_);
    return result_;
  }
  ...
  static boolean dq_string_content(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, true, false, recover_dq_string_parser_);
    return true;
  }
  ...
  static boolean hash_expr_item(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_, level_, _NONE_);
    result_ = pair_expr(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, recover_hash_expr_item_parser_);
    return result_;
  }
  ...
  static boolean sq_string_content(PsiBuilder builder_, int level_) {
    ...
    exit_section_(builder_, level_, marker_, true, false, recover_sq_string_parser_);
    return true;
  }
  ...
  static boolean variable_braced_content(PsiBuilder builder_, int level_) {
    ...
    Marker marker_ = enter_section_(builder_, level_, _NONE_);
    result_ = identifier_expr_content(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, recover_braced_variable_parser_);
    return result_;
  }
  ...
  static final Parser recover_array_content_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return recover_array_content(builder_, level_ + 1);
    }
  };
  static final Parser recover_braced_variable_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return recover_braced_variable(builder_, level_ + 1);
    }
  };
  static final Parser recover_dq_string_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return recover_dq_string(builder_, level_ + 1);
    }
  };
  static final Parser recover_hash_expr_item_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return recover_hash_expr_item(builder_, level_ + 1);
    }
  };
  static final Parser recover_parenthesised_item_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return recover_parenthesised_item(builder_, level_ + 1);
    }
  };
  static final Parser recover_sq_string_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder_, int level_) {
      return recover_sq_string(builder_, level_ + 1);
    }
  };
}
