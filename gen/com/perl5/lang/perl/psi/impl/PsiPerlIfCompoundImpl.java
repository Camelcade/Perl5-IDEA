...
import com.perl5.lang.perl.psi.PsiPerlIfCompound;
...
public class PsiPerlIfCompoundImpl extends PerlLexicalScopeMemberMixin implements PsiPerlIfCompound
{

	public PsiPerlIfCompoundImpl(ASTNode node)
	{
		super(node);
	}
	...
	{
		if (visitor instanceof PsiPerlVisitor) ((PsiPerlVisitor) visitor).visitIfCompound(this);
