...
public class PsiPerlForCompoundImpl extends PerlLexicalScopeMemberMixin implements PsiPerlForCompound
{
	...
	{
		if (visitor instanceof PsiPerlVisitor) ((PsiPerlVisitor) visitor).visitForCompound(this);
