...
public class PerlCodeChunkValidImpl extends ASTWrapperPsiElement implements PerlCodeChunkValid {

  public PerlCodeChunkValidImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PerlVisitor) ((PerlVisitor)visitor).visitCodeChunkValid(this);
