...
public class PerlPerlExpressionImpl extends ASTWrapperPsiElement implements PerlPerlExpression {

  public PerlPerlExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof PerlVisitor) ((PerlVisitor)visitor).visitPerlExpression(this);
  ...
  @Override
  @NotNull
  public List<PerlPerlSubexpression> getPerlSubexpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, PerlPerlSubexpression.class);
  }
