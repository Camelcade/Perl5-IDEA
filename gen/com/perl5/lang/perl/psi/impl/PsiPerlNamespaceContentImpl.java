...
public class PsiPerlNamespaceContentImpl extends ASTWrapperPsiElement implements PsiPerlNamespaceContent
{

	public PsiPerlNamespaceContentImpl(ASTNode node)
	{
		super(node);
	}
	...
	{
		if (visitor instanceof PsiPerlVisitor) ((PsiPerlVisitor) visitor).visitNamespaceContent(this);
