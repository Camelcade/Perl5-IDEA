...
public class PsiPerlBlockImpl extends PerlLexicalScopeMemberMixin implements PsiPerlBlock
{
	...
	{
		if (visitor instanceof PsiPerlVisitor) ((PsiPerlVisitor) visitor).visitBlock(this);
