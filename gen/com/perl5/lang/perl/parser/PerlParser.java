...
public class PerlParser implements PsiParser {
  ...
  public void parseLight(IElementType t, PsiBuilder b) {
    ...
    else if (t == LEXICAL_VARIABLE) {
      r = lexical_variable(b, 0);
    }
  ...
  public static boolean array_variable(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<array variable>", PERL_ARRAY, PERL_ARRAY_BUILT_IN)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<array variable>");
    r = consumeToken(b, PERL_ARRAY);
    if (!r) r = consumeToken(b, PERL_ARRAY_BUILT_IN);
  ...
  public static boolean eval_term(PsiBuilder b, int l) {
    ...
    r = r && eval_term_1(b, l + 1);
    exit_section_(b, l, m, EVAL_TERM, r, false, null);
    return r;
  }

  // '('expr')' | block_safe | expr
  private static boolean eval_term_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "eval_term_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = eval_term_1_0(b, l + 1);
    if (!r) r = block_safe(b, l + 1);
    if (!r) r = expr(b, l + 1, -1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // '('expr')'
  private static boolean eval_term_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "eval_term_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, PERL_LPAREN);
    r = r && expr(b, l + 1, -1);
  ...
  // {expr}
  private static boolean glob_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "glob_1_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = expr(b, l + 1, -1);
    exit_section_(b, m, null, r);
  ...
  public static boolean glob_variable(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<glob variable>", PERL_GLOB, PERL_GLOB_BUILT_IN)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<glob variable>");
    r = consumeToken(b, PERL_GLOB);
    if (!r) r = consumeToken(b, PERL_GLOB_BUILT_IN);
  ...
  public static boolean hash_variable(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<hash variable>", PERL_HASH, PERL_HASH_BUILT_IN)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<hash variable>");
    r = consumeToken(b, PERL_HASH);
    if (!r) r = consumeToken(b, PERL_HASH_BUILT_IN);
  ...
  public static boolean lexical_variable(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "lexical_variable")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<lexical variable>");
    r = scalar_variable(b, l + 1);
    if (!r) r = array_variable(b, l + 1);
    if (!r) r = hash_variable(b, l + 1);
    exit_section_(b, l, m, LEXICAL_VARIABLE, r, false, null);
    return r;
  }

  /* ********************************************************** */
  // lexical_variable | "undef"
  static boolean lexical_variable_definition_argument(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "lexical_variable_definition_argument")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // '(' variable (',' variable ) * ')'
  //     | variable
  static boolean local_variable_definition_variation(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "local_variable_definition_variation")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = local_variable_definition_variation_0(b, l + 1);
    if (!r) r = variable(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // '(' variable (',' variable ) * ')'
  private static boolean local_variable_definition_variation_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "local_variable_definition_variation_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, PERL_LPAREN);
    r = r && variable(b, l + 1);
    r = r && local_variable_definition_variation_0_2(b, l + 1);
    r = r && consumeToken(b, PERL_RPAREN);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // (',' variable ) *
  private static boolean local_variable_definition_variation_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "local_variable_definition_variation_0_2")) return false;
    int c = current_position_(b);
    while (true) {
      if (!local_variable_definition_variation_0_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "local_variable_definition_variation_0_2", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  // ',' variable
  private static boolean local_variable_definition_variation_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "local_variable_definition_variation_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  static boolean named_unary_expr_normal(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "named_unary_expr_normal")) return false;
    if (!nextTokenIs(b, PERL_OPERATOR_UNARY)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, PERL_OPERATOR_UNARY);
    r = r && named_unary_expr_normal_1(b, l + 1);
    r = r && expr(b, l + 1, -1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // !"("
  private static boolean named_unary_expr_normal_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "named_unary_expr_normal_1")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NOT_, null);
    r = !consumeToken(b, PERL_LPAREN);
    exit_section_(b, l, m, null, r, false, null);
  ...
  /* ********************************************************** */
  // 'defined' !"(" [expr]
  static boolean named_undry_expr_defined(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "named_undry_expr_defined")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, "defined");
    r = r && named_undry_expr_defined_1(b, l + 1);
    r = r && named_undry_expr_defined_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // !"("
  private static boolean named_undry_expr_defined_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "named_undry_expr_defined_1")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NOT_, null);
    r = !consumeToken(b, PERL_LPAREN);
    exit_section_(b, l, m, null, r, false, null);
  ...
  // [expr]
  private static boolean named_undry_expr_defined_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "named_undry_expr_defined_2")) return false;
    expr(b, l + 1, -1);
    return true;
  }
  ...
  static boolean open_arguments(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = open_arguments_0(b, l + 1);
    if (!r) r = open_arguments_1(b, l + 1);
    if (!r) r = open_arguments_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // open_handle "," open_mode "," open_ref
  private static boolean open_arguments_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "open_arguments_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = open_handle(b, l + 1);
    r = r && consumeToken(b, PERL_COMMA);
  ...
  // open_handle ["," expr]
  private static boolean open_arguments_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "open_arguments_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = open_handle(b, l + 1);
    r = r && open_arguments_2_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // ["," expr]
  private static boolean open_arguments_2_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "open_arguments_2_1")) return false;
    open_arguments_2_1_0(b, l + 1);
    return true;
  }

  // "," expr
  private static boolean open_arguments_2_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "open_arguments_2_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, PERL_COMMA);
    r = r && expr(b, l + 1, -1);
  ...
  /* ********************************************************** */
  // <<parseBarewordHandle>> | "{" scalar_expr "}" | <<parseExpressionLevel 21>>
  static boolean perl_handle(PsiBuilder b, int l) {
    ...
    if (!r) r = parseExpressionLevel(b, l + 1, 21);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // 'require' (perl_package | perl_version | expr)
  ...
  static boolean scalar(PsiBuilder b, int l) {
    ...
    if (!r) r = consumeToken(b, PERL_SCALAR_INDEX);
    if (!r) r = scalar_7(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // nested_element ?
  private static boolean scalar_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "scalar_0_2")) return false;
    nested_element(b, l + 1);
    return true;
  }
  ...
  // PERL_SIGIL_SCALAR +
  private static boolean scalar_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "scalar_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    ...
    while (r) {
      if (!consumeToken(b, PERL_SIGIL_SCALAR)) break;
      if (!empty_element_parsed_guard_(b, "scalar_1_0", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  // PERL_SIGIL_SCALAR_INDEX PERL_SIGIL_SCALAR * ( '{' expr '}' | scalar_variable )
  private static boolean scalar_7(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "scalar_7")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, PERL_SIGIL_SCALAR_INDEX);
    r = r && scalar_7_1(b, l + 1);
    r = r && scalar_7_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // PERL_SIGIL_SCALAR *
  private static boolean scalar_7_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "scalar_7_1")) return false;
    int c = current_position_(b);
    while (true) {
      if (!consumeToken(b, PERL_SIGIL_SCALAR)) break;
      if (!empty_element_parsed_guard_(b, "scalar_7_1", c)) break;
      c = current_position_(b);
    }
    return true;
  }
  ...
  private static boolean scalar_7_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "scalar_7_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = scalar_7_2_0(b, l + 1);
  ...
  // '{' expr '}'
  private static boolean scalar_7_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "scalar_7_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, PERL_LBRACE);
    r = r && expr(b, l + 1, -1);
  ...
  public static boolean scalar_call(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<scalar call>", PERL_SCALAR, PERL_SCALAR_BUILT_IN)) return false;
    boolean r;
  ...
  public static boolean scalar_variable(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<scalar variable>", PERL_SCALAR, PERL_SCALAR_BUILT_IN)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<scalar variable>");
    r = consumeToken(b, PERL_SCALAR);
    if (!r) r = consumeToken(b, PERL_SCALAR_BUILT_IN);
  ...
  private static boolean sort_op_arguments_0(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = parseBarewordFunction(b, l + 1, PERL_FUNCTION);
    r = r && expr(b, l + 1, -1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  public static boolean undef_term(PsiBuilder b, int l) {
    ...
    r = r && undef_term_1(b, l + 1);
    exit_section_(b, l, m, UNDEF_TERM, r, false, null);
    return r;
  }

  // variable ?
  private static boolean undef_term_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "undef_term_1")) return false;
    variable(b, l + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // 'local' [perl_package]  local_variable_definition_variation
  public static boolean variable_declaration_local(PsiBuilder b, int l) {
    ...
    r = r && local_variable_definition_variation(b, l + 1);
  ...
  static boolean variable_definition_variation(PsiBuilder b, int l) {
    ...
    if (!r) r = lexical_variable_definition_argument(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  private static boolean variable_definition_variation_0(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b);
    r = consumeToken(b, PERL_LPAREN);
    r = r && lexical_variable_definition_argument(b, l + 1);
  ...
  // 13: ATOM(named_unary_expr) ATOM(filetest_expr)
  ...
  private static boolean comma_expr_0_0_0(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = comma_expr_0_0_0_0(b, l + 1);
    int c = current_position_(b);
    while (r) {
      if (!comma_expr_0_0_0_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "comma_expr_0_0_0", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
  ...
  // ','|'=>'
  private static boolean comma_expr_0_0_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "comma_expr_0_0_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
  ...
  // named_undry_expr_defined | named_unary_expr_normal
  public static boolean named_unary_expr(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "named_unary_expr")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<named unary expr>");
    r = named_undry_expr_defined(b, l + 1);
    if (!r) r = named_unary_expr_normal(b, l + 1);
  ...
  // ["[" expr "]"]
  private static boolean term_expr_3_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "term_expr_3_3")) return false;
    term_expr_3_3_0(b, l + 1);
    return true;
  }

  // "[" expr "]"
  private static boolean term_expr_3_3_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "term_expr_3_3_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokenSmart(b, PERL_LBRACK);
    r = r && expr(b, l + 1, -1);
