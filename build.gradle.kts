...
fun spaceUser(): String = providers.gradleProperty("spaceUsername").orElse(environment("SPACE_USER")).get()
fun spacePass(): String = providers.gradleProperty("spacePassword").orElse(environment("SPACE_KEY")).get()
